...
if ($func->isPOST())
{
    ...
    //xử lý insert
    $dataInsert = [
        'image' => $func->upload('imageUpload', 'favicon'),
    ];
    $insertStatus = $db->update('images', $dataInsert, "type = 'favicon'");
    if ($insertStatus)
    {
...
$logo = $db->oneRaw("SELECT * FROM images WHERE type = 'favicon'")['image'];
...
<main id="content" class="col-md-9 ms-auto col-lg-10 px-md-4 py-4 overflow-auto">
    <p class="fw-bold fs-4 text-center">Favicon</p>
    <div class="container">
        <div class="row">
            <?php if (!empty($smg))
            {
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="col">
                    <div class="form-group">
                        <img id="previewImage" src="../assets/images/favicon/<?= $logo ?>" alt="Ảnh xem trước"
